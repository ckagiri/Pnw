(function () {
    ...
    angular.module('app').controller(controllerId, ['$dialog', '$location','$route', '$scope', '$timeout', 'auth', 'events', 'identity', navigation]);

    function navigation($dialog, $location, $route, $scope, $timeout, auth, events, identity) {
        var vm = this;
